(function () {
    ...
    edtApp.constant('APP_MSG', {
        ...
        caseYnConfirm : "구매 확정된 주문은 처리할 수 없습니다.",
	...
	edtApp.constant('APP_SA_MODEL', {
	    ...
	    CCL_NO_UPDATE 		: { field: "CCL_NO_UPDATE"		 , type: "string" , width: "100px", textAlign: "center"		, title: "취소요청 처리자"},
        ...
        DTS_TKBKAPPRRJT		: { field: "DTS_TKBKAPPRRJT"     , type: "string" , width: "100px", textAlign: "center"		, title: "반품요청 처리일시"},
        NO_TKBKAPPRRJT		: { field: "NO_TKBKAPPRRJT"  	 , type: "string" , width: "100px", textAlign: "center"		, title: "반품요청 처리자"},
        NO_TKBKCPLT   		: { field: "NO_TKBKCPLT"  		 , type: "string" , width: "100px", textAlign: "center"		, title: "반품 완료자"},
        ...
        DTS_RECE     		: { field: "DTS_RECE"    		 , type: "string" , width: "100px", textAlign: "center"		, title: "반납상품 수령일시"},
        NO_RECER     		: { field: "NO_RECER"    		 , type: "string" , width: "100px", textAlign: "center"		, title: "반납상품 수령자"},
        ...
        OTHER_ORDSTAT		: { field: "OTHER_ORDSTAT"   	 , type: "string" , width: "100px", textAlign: "right" 		, title: "요청상태"},
	});
}());
